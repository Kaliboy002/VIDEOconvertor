...
async def start(event):
    await event.reply(f'{st}')  # Removed the buttons argument
...
async def source(event):
    await event.edit(source_text,
                    buttons=[[
                         Button.url("FOR PERS", url="https://github.com/vasusen-code/videoconvertor/tree/main"),
                         Button.url("FOR YOUR  ", url="https://github.com/vasusen-code/videoconvertor/")]])
